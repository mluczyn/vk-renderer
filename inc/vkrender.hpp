...
namespace vw {
enum AttachmentUse { Color, DepthStencil, Resolve };
...
class RenderPass : public vw::HandleContainerUnique<vk::RenderPass> {
 public:
  ...
  static inline constexpr AttachmentInfo colorAtt(vk::Format format,
    ...
    return {AttachmentUse::Color, vk::AttachmentDescription{{},
                                                            format,
                                                            sampleCount,
  ...
  static inline constexpr AttachmentInfo resolvePresentAtt(vk::Format format) {
    return {AttachmentUse::Resolve, vk::AttachmentDescription{{},
                                                              format,
...
constexpr vk::ColorComponentFlags AllColorComponents =
...
class GraphicsPipelineBuilder {
 public:
  ...
  inline void setRasterizationState(vk::PolygonMode polygonMode, vk::CullModeFlags cullMode, vk::FrontFace frontFace = vk::FrontFace::eClockwise) {
